...
\rm -f z.plot
\rm -f plot84.ps
/opt/qb3/ccp4-6.1/bin/npo mapin averageplot_CC_v101.mrc plot z.plot << eof
NOTITLE
MAP SCALE 1 INVERT
# For CCC
...
/opt/qb3/ccp4-6.1/bin/pltdev -log -dev ps -abs -pen c -xp 3.1 -yp 3.1 -lan -i z.plot -o frehand_CC.ps
